...
| 意见反馈 | (无) | post /feedback/add | **GAP-I-01: 已补后端端点** |

## 3. 差异与处理
| 编号 | 级别 | 说明 | 处理 |
|---|---|---|---|
| GAP-I-01 | P1 | 反馈提交 /feedback/add 后端不存在,提交必失败 | 已新增后端端点、数据库 migration、前端 typed client 和测试,状态 FIXED |
...
- 结论: 设置/关于/协议/隐私/文章与旧版一致或更稳;反馈端点已补齐并有测试覆盖。
