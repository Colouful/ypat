/*
 * @Author: shawn
 * @LastEditTime: 2020-04-13 20:31:42
 */
/**
 * 通用uni-app网络请求
...
export default {
  config: {
    ...
    // #endif
    header: {
      // Token:'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMDAiLCJjcmVhdGVkIjoxNTc0MDQyNjM5NjMwLCJleHAiOjE2MDU1Nzg2Mzl9.PSgwDvdcyi0M7FMF3ziH6R4p00J_FtewH2F22tnzzpUErby90mzc7mFF6dDm2Yw__cJxFgF3I0_gqM-gEdqoBQ',
  ...
  request(options) {
    ...
    if (uni.getStorageSync(localStorageObj.token)) {
      options.header = Object.assign(
        ...
        options.header,
        {
          Token: uni.getStorageSync(localStorageObj.token),
        }
      );
    }
