<template name="w-picker">
  <view class="w-picker" :key="createKey" :data-key="createKey">
    <view
      ...
      catchtouchmove="true"
    ></view>
    <view class="w-picker-cnt" :class="{'visible':visible&&!showView,'showView':visible&&showView}">
      <view v-if="!showView" class="w-picker-header" @touchmove.stop.prevent catchtouchmove="true">
...
export default {
  ...
  methods: {
    ...
    handlerChange(res) {
      let _this = this;
      this.result = { ...res };
      this.showView && this.pickerConfirm();
    },
    show() {
      this.visible = true;
    },
