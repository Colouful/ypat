<template>
  <view
    ...
    :class="{'tui-cell-arrow':arrow,'tui-cell-last':last,'tui-cell-bottomLine':!bottomLine,'tui-line-left':lineLeft,'tui-line-right':lineRight,'tui-radius':radius}"
