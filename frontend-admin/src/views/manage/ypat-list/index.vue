    ...
    <el-table v-loading="loading" :data="list" border stripe>
      ...
      <el-table-column label="操作" width="180" align="center" fixed="right">
        <template #default="{row}">
          ...
          <el-button type="success" link size="small" v-if="row.recomflag !== RecomFlag.YES.value" @click="doRecom(row as unknown as YpatInfo, RecomFlag.YES.value)">推荐</el-button>
          <el-button type="info" link size="small" v-else @click="doRecom(row as unknown as YpatInfo, RecomFlag.NO.value)">取消推荐</el-button>
        </template>
      </el-table-column>
    </el-table>
