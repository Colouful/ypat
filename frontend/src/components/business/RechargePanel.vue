...
.recharge { min-height: 100vh; box-sizing: border-box; padding: 28rpx; background: #f7f8fa; }
.balance-card { padding: 38rpx; border-radius: 28rpx; color: #fff; background: linear-gradient(135deg, #23c268, #64d995); }
...
.state, .unsupported { margin-top: 28rpx; padding: 32rpx; border-radius: 22rpx; color: #747e8d; background: #fff; text-align: center; }
.products { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20rpx; margin-top: 28rpx; }
.product { padding: 34rpx 20rpx; border: 2rpx solid transparent; border-radius: 22rpx; background: #fff; text-align: center; }
.product.active { border-color: #23c268; background: #effaf4; }
.product__amount { display: block; color: #1d2433; font-size: 30rpx; font-weight: 600; }
.product__price { display: block; margin-top: 12rpx; color: #f26a3d; font-size: 27rpx; }
.pay { margin-top: 40rpx; height: 92rpx; line-height: 92rpx; border-radius: 46rpx; color: #fff; background: #23c268; }
