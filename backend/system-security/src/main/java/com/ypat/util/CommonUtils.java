...
public class CommonUtils {
    ...
    public static boolean isNull(Object value) {
        if (value == null) {
            ...
            if ("".equals(((String) value).trim().replaceAll("\\s", ""))) {
                return true;
            }
    ...
    public static boolean isAlpha(String value) {
        ...
        return matches(REG_ALPHA, value);
    }
    ...
    public static boolean isAlphanum(String value) {
        ...
        return matches(REG_ALPHANUM, value);
    }
    ...
    public static boolean isNumber(String value) {
        ...
        return matches(REG_NUMBER, value);
    }
    ...
    public static boolean isStartNumber(String value) {
        ...
        return matches(REG_START_NUMBER, value);
    }
    ...
    public static boolean isInteger(String value) {
        ...
        return matches(REG_INTEGER, value);
    }
    ...
    public static boolean isFloat(String value) {
        ...
        return matches(REG_FLOAT, value);
    }
    ...
    public static boolean isMoney(String value) {
        ...
        return matches(REG_MONEY, value);
    }
    ...
    public static boolean isPhone(String value) {
        ...
        return matches(REG_PHONE, value);
    }
    ...
    public static boolean isMobile(String value) {
        ...
        return matches(REG_MOBILE, value);
    }
    ...
    public static boolean isEmail(String value) {
        ...
        return matches(REG_EMAIL, value);
    }

    public static boolean isZip(String value) {

        return matches(REG_ZIP, value);
    }

    public static boolean isIP(String value) {

        return matches(REG_IP, value);
    }

    public static boolean isURL(String value) {

        return matches(REG_URL, value);
    }

    public static boolean isChinese(String value) {

        return matches(REG_CHINESE, value);
    }
    ...
    public static boolean isIdcard(String value) {
        ...
        if (!(matches("^\\d{17}(\\d|X)$", value) || matches("\\d{15}$", value))) {
            return false;
        }
