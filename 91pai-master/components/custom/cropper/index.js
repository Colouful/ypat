...
export default {
  ...
  methods: {
    ...
    fSelect() {
      let self = this;
      if (this.fSelecting || this.styleDisplay !== "none") return;
            ...
            success: r => {
              ...
              if (!this.hasSel) {
                ...
                if (this.selWidth && this.selHeight) {
                  ...
                  style.top = parseInt(
                    (this.windowHeight - style.height - tabHeight) / 2
                  );
    ...
    fDrawInit(ini = false) {
      ...
      ctxCanvasOper.fillRect(
        ...
        top + height,
        this.windowWidth,
        this.windowHeight - height - tabHeight - top
      );
      ctxCanvasOper.fillRect(
        left + width,
        top,
    ...
    fMove(e) {
      ...
      if (touch1) {
        ...
        if (touch1.x !== touch0.x && this.letRotate) {
          x =
            (this.touch1.clientY - this.touch0.clientY) /
            (this.touch1.clientX - this.touch0.clientX);
          y =
