...
public class SysResultHandler implements ResponseBodyAdvice<Object> {
    ...
    public String beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        ResponseApiBody resBody = null;
        if(body==null) {
            resBody = ResponseApiBody.success(null);
        } else if (body instanceof ResponseApiBody) {
            resBody = (ResponseApiBody)body;
        } else if (body instanceof String){
            Object obj = GsonUtils.fromJson((String)body, Object.class);
            resBody = ResponseApiBody.success(obj);
        }
        String res = GsonUtils.toJson(resBody);
        return res;
    }
}
