...
const initPicker = {
      ...
      switch (mode) {
        case "half":
          dvalDate = flag
            ...
            : [...value.split(" ")[0].split("-"), value.split(" ")[1]];
          break;
        case "date":
        case "yearMonth":
        ...
        case "dateTime":
          if (flag) {
            ...
            defaultVal = [
              ...
              minutes.indexOf(dvalDate[4]) == -1
                ? 0
                : minutes.indexOf(dvalDate[4]),
              seconds.indexOf(dvalDate[5]) == -1
                ? 0
                : seconds.indexOf(dvalDate[5])
            ];
          }
        ...
        case "time":
          if (flag) {
            ...
            defaultVal = [
              ...
              minutes.indexOf(dvalDate[1]) == -1
                ? 0
                : minutes.indexOf(dvalDate[1]),
              seconds.indexOf(dvalDate[2]) == -1
                ? 0
                : seconds.indexOf(dvalDate[2])
            ];
          }
  ...
  limit: {
    ...
    initHours(
      ...
      let hour = bsDate.getHours();
      let flag =
        dYear == arr[0] && dMonth == arr[1] && dDate == arr[2] ? true : false;
      if (hour > endHour) {
        hour = endHour;
      }
      if (flag) {
