...
public class OAuthConfigurer extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients)
            throws Exception {
        clients.inMemory()
                .withClient("ssoclient0").secret("ssosecret0").autoApprove(true).authorizedGrantTypes("authorization_code", "refresh_token").scopes("openid")
                .and()
                .withClient("ssoclient1").secret("ssosecret1").autoApprove(true).authorizedGrantTypes("password", "refresh_token").scopes("openid");
    }
